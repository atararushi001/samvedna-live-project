                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1>Recruiter <span class="table-project-n">Data</span> Table</h1>
                                </div>
                            </div>
                                        ...
                                        <tbody style="color: white;">
                                            ...
                                            <tr>
                                                ...
                                                <td class="datatable-ct">
                                                    <!-- <a style="color:green;" href="edit.php?id=<?php echo $row['recruiters_id']; ?>">Edit</a> -->
                                                    <a style="color:red;" href="delete.php?id=<?php echo $row['recruiters_id']; ?>">Delete</a>
                                                </td>
                                            </tr>
                                            <?php } ?>
