                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1>Job Seekers <span class="table-project-n">Data</span> Table</h1>
                                </div>
                            </div>
                            <div class="sparkline13-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    ...
                                    <table style="color: white;" id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
												...
												<th data-field="permanentAddress" >permanentAddress</th>
												<th data-field="currentAddress" >currentAddress</th>
												<th data-field="city" >city</th>
												<th data-field="state" >state</th>
												<th data-field="country" >country</th>
												<th data-field="postalCode" >postalCode</th>
												<th data-field="contactNumber" >contactNumber</th>
												<th data-field="whatsappNumber" >whatsappNumber</th>
												<th data-field="homePhone" >homePhone</th>
												<th data-field="qualification" >qualification</th>
												<th data-field="educationSpecialization" >educationSpecialization</th>
                                        ...
                                        <tbody style="color: white;">
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $row['educationSpecialization']; ?></td>
                                                
                                                
                                             
                                                <td class="datatable-ct">
                                                    <a style="color:red;" href="delete.php?id=<?php echo $row['job_seeker_id']; ?>">Delete</a>
