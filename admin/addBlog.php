                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                            <div class="admin-content analysis-progrebar-ctn res-mg-t-15">
                                <h4 class="text-left text-uppercase text-center"><b>Total recruiter</b></h4>
                                <div class="row vertical-center-box vertical-center-box-tablet">
                                 
                                    <div class="text-left text-uppercase text-center cus-gh-hd-pro">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                            <div class="admin-content analysis-progrebar-ctn res-mg-t-15">
                                <h4 class="text-left text-uppercase text-center"><b>Total Job Seekers</b></h4>
                                <div class="row vertical-center-box vertical-center-box-tablet">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                            <div class="admin-content analysis-progrebar-ctn res-mg-t-15">
                                <h4 class="text-left text-uppercase text-center"><b>Total Self Employment</b></h4>
                                <div class="row vertical-center-box vertical-center-box-tablet">
