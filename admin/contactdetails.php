                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1>Contact <span class="table-project-n">Data</span> Table</h1>
                                </div>
                            </div>
                                    ...
                                    <table style="color: white;" id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="contact_id">ID</th>
                                        ...
                                        <tbody style="color: white;">
                                            ...
                                            <tr>
                                                ...
                                                <td class="datatable-ct">
                                                    <!-- <a style="color:green;" href="edit.php?id=<?php echo $row['contact_id']; ?>">Edit</a> -->
                                                    <a style="color:red;" href="delete.php?id=<?php echo $row['contact_id']; ?>">Delete</a>
                                                </td>
                                            </tr>
                                            <?php } ?>
