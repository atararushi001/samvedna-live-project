...
const EditMatrimonyUser = ({ matrimonyUser, setView }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    const response = await fetch(
      `${API}/admin/update-matrimony-user/${matrimonyUser.id}`,
      {
        method: "PUT",
        headers: {
  ...
  return (
    <div className="edit-matrimony-user">
      <h1>Edit Matrimony User</h1>
...
EditMatrimonyUser.propTypes = {
  setView: PropTypes.func.isRequired,
  matrimonyUser: PropTypes.object.isRequired,
};
